...
export default function ListaCodigos({
  ...
  // Vazio na tela geral (/painel/estoque), preenchido quando a lista esta
  // dentro de um produto. Serve so para saber quais caminhos revalidar.
  handle?: string;
  linhas: LinhaEstoque[];
  podeMover: boolean;
  podeCusto: boolean;
        ...
        <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "0.86rem" }}>
          <thead>
            <tr style={{ textAlign: "left", color: "var(--texto-fraco)", fontSize: "0.7rem" }}>
              ...
              {mostrarProduto ? <th style={th}>PRODUTO</th> : null}
          ...
          <tbody>
            {linhasSeguras.length === 0 ? (
              <tr>
                <td colSpan={mostrarProduto ? 10 : 9} style={{ ...td, color: "var(--texto-fraco)" }}>
            ...
            {linhasSeguras.map((l) => (
              ...
              >
                ...
                {mostrarProduto ? (
                  <td style={{ ...td, color: "var(--texto-fraco)" }}>{l.produto ?? "—"}</td>
                ) : null}
                <td style={td}>
